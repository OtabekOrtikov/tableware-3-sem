...
public class JDBCTablewareDAO implements ITablewareDAO {
    ...
    public JDBCTablewareDAO(TransactionManager transactionManager) {
    ...
    private Tableware mapResultSetToTableware(ResultSet rs) throws DaoException {
        try {
            ...
            return switch (type.toUpperCase()) {
                ...
                default -> throw new DaoException("Unknown type of tableware retrieved from DB: " + type + " for id " + id);
            };
        } catch (SQLException e) {
